...
Вывод: список лежит дальше `0x2000`. Следующая попытка — те же два снимка, но окном `0x10000`.
Широкий снимок «портал есть» уже снят; нужен парный «портала нет» в незагородной зоне.
