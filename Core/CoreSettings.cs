...
/// <summary>
/// Settings for the HUD core itself (rendering, threading, performance and menu options).
/// Each property is surfaced in the settings menu via its <see cref="ExileCore.Shared.Attributes.MenuAttribute"/>.
/// </summary>
