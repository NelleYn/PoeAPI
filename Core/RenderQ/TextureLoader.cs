...
/// <summary>
/// Helper methods for loading bitmaps via WIC and turning them into Direct3D11 textures.
/// </summary>
public class TextureLoader
{
    ...
    /// </summary>
    /// <param name="factory">The WIC imaging factory used to decode the file.</param>
    /// <param name="filename">The path of the image file to load.</param>
    /// <returns>The decoded bitmap as a <see cref="BitmapSource"/>.</returns>
    ...
    /// <summary>
    /// Creates a <see cref="SharpDX.Direct3D11.Texture2D" /> from a GDI+ <see cref="System.Drawing.Bitmap" />.
    /// </summary>
    /// <param name="device">The Direct3D11 device.</param>
    /// <param name="bitmap">The source bitmap.</param>
    /// <param name="Usage">The resource usage for the created texture.</param>
    /// <param name="cpuAccessFlags">The CPU access flags for the created texture.</param>
    /// <returns>A Texture2D.</returns>
