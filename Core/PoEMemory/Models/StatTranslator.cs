...
public class StatTranslator
{
    ...
    /// <summary>Builds the translation table mapping known mod names to their stat handlers.</summary>
    ...
    /// <summary>
    /// Applies the contribution of the given mod to the supplied stats accumulator,
    /// silently ignoring mods that have no registered translation.
    /// </summary>
    /// <param name="stats">The accumulator to update.</param>
    /// <param name="m">The item mod to translate and apply.</param>
