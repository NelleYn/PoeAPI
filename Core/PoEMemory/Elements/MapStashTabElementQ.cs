...
/// <summary>
/// UI element for the map stash tab, exposing map counts and the currently selected cell by reading the UI tree.
/// </summary>
public class MapStashTabElementQ : Element
{
    /// <summary>
    /// Gets map names mapped to their displayed counts.
    /// </summary>
